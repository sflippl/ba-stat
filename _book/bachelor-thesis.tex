...
\item
  ...
  \begin{figure}
  \includegraphics[width=0.7\linewidth]{bachelor-thesis_files/figure-latex/vdem-spatial-1} \caption{Country borders in 2017 in the V-Dem database}\label{fig:vdem-spatial}
  \end{figure}
\item
...
\StringTok{  }\KeywordTok{fx_ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ v2x_polyarchy)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{my_theme }\CommentTok{# my_theme makes the text larger}
\end{Highlighting}
\end{Shaded}

\begin{figure}

{\centering \includegraphics[width=0.5\linewidth]{bachelor-thesis_files/figure-latex/3-1-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{bachelor-thesis_files/figure-latex/3-2-1} 
...
\StringTok{  }\KeywordTok{fx_ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ v2x_polyarchy, }\DataTypeTok{y =}\NormalTok{ v2x_libdem)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{my_theme}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.5\linewidth]{bachelor-thesis_files/figure-latex/3-4-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{bachelor-thesis_files/figure-latex/3-5-1} 
...
\StringTok{  }\KeywordTok{fx_ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ v2x_polyarchy, }\DataTypeTok{y =}\NormalTok{ v2x_libdem, }\DataTypeTok{colour =}\NormalTok{ year)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{my_theme}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.5\linewidth]{bachelor-thesis_files/figure-latex/3-6-1} 
...
\StringTok{  }\KeywordTok{fx_ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ year, }\DataTypeTok{y =}\NormalTok{ v2x_libdem, }\DataTypeTok{colour =}\NormalTok{ country_name)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{my_theme}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.5\linewidth]{bachelor-thesis_files/figure-latex/3-8-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# To modify default values, we need to define a function that changes }
\CommentTok{# the fxGeom_class of the questionable names and returns that }
\CommentTok{# (modified or unmodified) argument.}
...
\StringTok{  }\CommentTok{# If called without an argument, fx_default simply instantiates the }
\StringTok{  }\CommentTok{# metaframe with the names.}
...
\StringTok{  }\CommentTok{# It accepts as an argument a function that changes the default classes.}
\StringTok{  }
\StringTok{  }\KeywordTok{mutate_mf}\NormalTok{(}
    ...
    \CommentTok{# The second variable specifies which observations should be viewed as}
    \CommentTok{# instances of a coherent unit, i. e. be connected by lines.}
...
{\centering \includegraphics[width=0.5\linewidth]{bachelor-thesis_files/figure-latex/3-9-1} 
...
\NormalTok{    )}
\NormalTok{  ) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{fx_ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ year, }\DataTypeTok{y =}\NormalTok{ v2x_libdem)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{my_theme}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.5\linewidth]{bachelor-thesis_files/figure-latex/3-10-1} 
...
{\centering \includegraphics[width=0.5\linewidth]{bachelor-thesis_files/figure-latex/bsp-1} 
...
\StringTok{  }\KeywordTok{fx_default}\NormalTok{(}\DataTypeTok{columns =}\NormalTok{ fx_ggplot_columns)}
\KeywordTok{metaframe}\NormalTok{(fx_diamonds)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{select}\NormalTok{(name, fxInfo_name}\OperatorTok{:}\NormalTok{fxInfo_unit)}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.5\linewidth]{bachelor-thesis_files/figure-latex/title-1} 
...
\StringTok{  }\KeywordTok{fx_ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ carat, }\DataTypeTok{y =}\NormalTok{ price), }\DataTypeTok{facet_vars =} \KeywordTok{vars}\NormalTok{(color)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{my_theme}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.7\linewidth]{bachelor-thesis_files/figure-latex/facets-1} 
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{vdem }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(v2x_polyarchy, v2x_libdem, v2x_partipdem, v2x_delibdem, v2x_egaldem) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{fx_info}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\StringTok{"name"}\NormalTok{, }\StringTok{"question"}\NormalTok{, }\StringTok{"stats"}\NormalTok{), }
          \DataTypeTok{statistics =} \KeywordTok{list}\NormalTok{(}
            ...
            \DataTypeTok{quantile =} \ControlFlowTok{function}\NormalTok{(x, ...) }
              \KeywordTok{quantile}\NormalTok{(x, }\DataTypeTok{probs =} \KeywordTok{seq}\NormalTok{(}\FloatTok{0.25}\NormalTok{, }\FloatTok{0.75}\NormalTok{, }\FloatTok{0.25}\NormalTok{), }
                       \DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{            )) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{name) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{fx_output}\NormalTok{(}\StringTok{"table"}\NormalTok{, }\DataTypeTok{out_format =} \StringTok{"markdown"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{vdem }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(v2x_polyarchy) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{fx_info}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\StringTok{"name"}\NormalTok{, }\StringTok{"question"}\NormalTok{, }\StringTok{"clarification"}\NormalTok{, }\StringTok{"stats"}\NormalTok{), }
          \DataTypeTok{statistics =} \KeywordTok{list}\NormalTok{(}
            \DataTypeTok{mean =} \ControlFlowTok{function}\NormalTok{(x, ...) }\KeywordTok{mean}\NormalTok{(x, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{),}
            \DataTypeTok{quantile =} \ControlFlowTok{function}\NormalTok{(x, ...) }\KeywordTok{quantile}\NormalTok{(x, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{            )}
\NormalTok{          ) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{fx_output}\NormalTok{(}\StringTok{"collapse"}\NormalTok{, }
            \DataTypeTok{cell_scheme =} \StringTok{"*\{name\}*}\CharTok{\textbackslash{}n}\StringTok{\{value\}"}\NormalTok{, }
            \DataTypeTok{cell_sep =} \StringTok{"}\CharTok{\textbackslash{}n\textbackslash{}n}\StringTok{"}\NormalTok{,}
            \DataTypeTok{out_format =} \StringTok{"markdown"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{p1 <-}\StringTok{ }\NormalTok{vdem }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(year }\OperatorTok{==}\StringTok{ }\DecValTok{2015}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(v2clrelig_osp, country_name, year) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{vdem_geocode}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{fx_ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{geom =}\NormalTok{ geometry, }\DataTypeTok{fill =}\NormalTok{ v2clrelig_osp)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{my_theme}

\NormalTok{p2 <-}\StringTok{ }\NormalTok{vdem }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(year }\OperatorTok{==}\StringTok{ }\DecValTok{2015}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(v2clrelig_ord, country_name, year) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{vdem_geocode}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{fx_ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{geom =}\NormalTok{ geometry, }\DataTypeTok{fill =}\NormalTok{ v2clrelig_ord)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{my_theme}
...
{\centering \includegraphics[width=0.6\linewidth]{bachelor-thesis_files/figure-latex/consistent-1} 

}

\caption{The ordinal scale provides a discretized version of the original scale.}\label{fig:consistent}
\end{figure}

Furthermore, we plot a time series with confidence intervals for
different countries in figure \ref{fig:time}.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{vdem }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(country_name }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Germany"}\NormalTok{, }\StringTok{"France"}\NormalTok{, }\StringTok{"Belgium"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(country_name, year, }\KeywordTok{contains}\NormalTok{(}\StringTok{"v2x_polyarchy"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{fx_ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ year, }\DataTypeTok{y =}\NormalTok{ v2x_polyarchy, }\DataTypeTok{colour =}\NormalTok{ country_name)) }\OperatorTok{+}
\StringTok{  }\NormalTok{my_theme}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.5\linewidth]{bachelor-thesis_files/figure-latex/time-1} 
...
\NormalTok{vdem }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(country_name, year, }\KeywordTok{contains}\NormalTok{(}\StringTok{"v2x_polyarchy"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{fx_ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ year, }\DataTypeTok{y =}\NormalTok{ v2x_polyarchy)) }\OperatorTok{+}
\StringTok{  }\NormalTok{my_theme}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.5\linewidth]{bachelor-thesis_files/figure-latex/time-all-1} 
...
\NormalTok{vdem }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(v2x_polyarchy, v2x_libdem) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{fx_ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ v2x_polyarchy, }\DataTypeTok{y =}\NormalTok{ v2x_libdem)) }\OperatorTok{+}
\StringTok{  }\NormalTok{my_theme}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.5\linewidth]{bachelor-thesis_files/figure-latex/scatter-1} 
...
\NormalTok{vdem }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(country_name }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Germany"}\NormalTok{, }\StringTok{"France"}\NormalTok{, }\StringTok{"Belgium"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(v2x_polyarchy, v2x_libdem, country_name, year) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{fx_ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ v2x_polyarchy, }\DataTypeTok{y =}\NormalTok{ v2x_libdem,}
                \DataTypeTok{colour =}\NormalTok{ year), }
            \DataTypeTok{facet_vars =} \KeywordTok{vars}\NormalTok{(country_name)) }\OperatorTok{+}
\StringTok{  }\NormalTok{my_theme}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.5\linewidth]{bachelor-thesis_files/figure-latex/scatter-facet-1} 

}

\caption{Electoral and liberal democracy index in Germany, France and Belgium over time}\label{fig:scatter-facet}
\end{figure}

The time series work for the low-level indices, as well, as can be seen
...
\NormalTok{vdem }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(country_name }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Germany"}\NormalTok{, }\StringTok{"France"}\NormalTok{, }\StringTok{"Belgium"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(}\KeywordTok{contains}\NormalTok{(}\StringTok{"v2meharjrn"}\NormalTok{), country_name, year) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{fx_ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ year, }\DataTypeTok{y =}\NormalTok{ v2meharjrn_osp, }\DataTypeTok{colour =}\NormalTok{ country_name)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\NormalTok{my_theme}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.5\linewidth]{bachelor-thesis_files/figure-latex/low-1} 
...
\StringTok{  }\KeywordTok{filter}\NormalTok{(country_name }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Germany"}\NormalTok{, }\StringTok{"France"}\NormalTok{, }\StringTok{"Belgium"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(}\KeywordTok{contains}\NormalTok{(}\StringTok{"v2meharjrn"}\NormalTok{), country_name, year) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{fx_ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ year, }\DataTypeTok{y =}\NormalTok{ v2meharjrn_ord, }\DataTypeTok{colour =}\NormalTok{ country_name)) }\OperatorTok{+}
\StringTok{  }\NormalTok{my_theme}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.5\linewidth]{bachelor-thesis_files/figure-latex/low-disc-1} 
...
\begin{Highlighting}[]
\NormalTok{vdem }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(}\KeywordTok{contains}\NormalTok{(}\StringTok{"v2meharjrn"}\NormalTok{), v2x_polyarchy, country_name, year) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{fx_ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ v2meharjrn_ord, }\DataTypeTok{y =}\NormalTok{ v2x_polyarchy)) }\OperatorTok{+}
\StringTok{  }\NormalTok{my_theme}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.5\linewidth]{bachelor-thesis_files/figure-latex/disc-high-1} 
