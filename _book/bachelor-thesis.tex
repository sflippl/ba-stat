...
\StringTok{  }\KeywordTok{select}\NormalTok{(name, }\KeywordTok{starts_with}\NormalTok{(}\StringTok{"fxInfo"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.7\linewidth]{bachelor-thesis_files/figure-latex/title-1} 
